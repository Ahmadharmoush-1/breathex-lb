      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-elegant">
            ...
            backgroundImage: "url('/photos/breathingtrainer.png')",
            ...
            border: "1px solid #ECECEC"
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Height:</span> 18 cm
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Weight:</span> 55g
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Minutes Per Day:</span> 5 min+
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Material:</span> 	BPA-Free Medical Grade Plastic
                    </div>
                  </div>
                </div>
              </div>
